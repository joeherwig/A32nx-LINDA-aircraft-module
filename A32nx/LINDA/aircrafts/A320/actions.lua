...
function A32nx_OVHD_calls_ALL()
    ...
    ipc.writeLvar("L:PUSH_OVHD_CALLS_ALL", 0)
end
...
function A32nx_WING_DEICE_OFF()
     ipc.control(66337, 0)
end

function A32nx_WING_DEICE_ON()
     ipc.control(66337, 1)
end

function A32nx_ENG_1_DEICE_OFF()
     ipc.control(66484, 0)
end

function A32nx_ENG_1_DEICE_ON()
     ipc.control(66484, 1)
end

function A32nx_ENG_2_DEICE_OFF()
     ipc.control(66485, 0)
end

function A32nx_ENG_2_DEICE_ON()
     ipc.control(66485, 1)
end
...
function A32nx_OVHD_APU_Master_On()
    ipc.writeLvar("L:A32NX_OVHD_APU_MASTER_SW_PB_IS_ON", 1)
end

function A32nx_OVHD_APU_Master_Off()
    ipc.writeLvar("L:A32NX_OVHD_APU_MASTER_SW_PB_IS_ON", 0)
end

function A32nx_OVHD_APU_Start_On()
    ipc.writeLvar("L:A32NX_OVHD_APU_START_PB_IS_ON", 1)
end

function A32nx_OVHD_APU_Start_Off()
    ipc.writeLvar("L:A32NX_OVHD_APU_START_PB_IS_ON", 0)
end

function A32nx_OVHD_APU_Bleed_On()
    ipc.writeLvar("L:A32NX_OVHD_PNEU_APU_BLEED_PB_IS_ON", 1)
end

function A32nx_OVHD_APU_Bleed_Off()
    ipc.writeLvar("L:A32NX_OVHD_PNEU_APU_BLEED_PB_IS_ON", 0)
end

-- ## Overhead EXT POWER #####################################

function A32nx_OVHD_Ext_Power_Toggle()
    ipc.control(067090, 1)
end

-- ## Overhead EMER LIGHTS #####################################

function A32nx_OVHD_Emer_Lights_On()
    ipc.writeLvar("L:XMLVAR_SWITCH_OVHD_INTLT_EMEREXIT_Position", 0)
end

function A32nx_OVHD_Emer_Lights_Auto()
    ipc.writeLvar("L:XMLVAR_SWITCH_OVHD_INTLT_EMEREXIT_Position", 1)
end

function A32nx_OVHD_Emer_Lights_Off()
    ipc.writeLvar("L:XMLVAR_SWITCH_OVHD_INTLT_EMEREXIT_Position", 2)
end

-- ## Overhead NO SMOKING #####################################

function A32nx_OVHD_NoSmoking_On()
    ipc.writeLvar("L:XMLVAR_SWITCH_OVHD_INTLT_NOSMOKING_Position", 0)
end

function A32nx_OVHD_NoSmoking_Auto()
    ipc.writeLvar("L:XMLVAR_SWITCH_OVHD_INTLT_NOSMOKING_Position", 1)
end

function A32nx_OVHD_NoSmoking_Off()
    ipc.writeLvar("L:XMLVAR_SWITCH_OVHD_INTLT_NOSMOKING_Position", 2)
end

-- ## Overhead CREW OXYGEN #####################################

function A32nx_OVHD_Crew_Oxygen_On()
    ipc.writeLvar("L:PUSH_OVHD_OXYGEN_CREW", 0)
end

function A32nx_OVHD_Crew_Oxygen_Off()
    ipc.writeLvar("L:PUSH_OVHD_OXYGEN_CREW", 1)
end

-- ## Pedestal #####################################

function A32nx_PED_PWS_On()
    ipc.writeLvar("L:A32NX_SWITCH_RADAR_PWS_Position", 1)
end

function A32nx_PED_PWS_Off()
...
function A32nx_Autobrake_Low_Toggle()
     if ipc.readLvar("L:XMLVAR_Autobrakes_Level") > 0 then A32nx_Autobrake_SET(0) else A32nx_Autobrake_SET(1) end
end

function A32nx_Autobrake_Mid_Toggle()
     if ipc.readLvar("L:XMLVAR_Autobrakes_Level") > 0 then A32nx_Autobrake_SET(0) else A32nx_Autobrake_SET(2) end
end

function A32nx_Autobrake_Max_Toggle()
     if ipc.readLvar("L:XMLVAR_Autobrakes_Level") > 0 then A32nx_Autobrake_SET(0) else A32nx_Autobrake_SET(3) end
end

function A32nx_Autobrake_SET(AutobrakeLevel)
     ipc.control(66723, 0)
     ipc.writeLvar("L:XMLVAR_Autobrakes_Level", AutobrakeLevel) 
